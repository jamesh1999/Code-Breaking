...
public:
    ...
    {
        SimpleSubstitution->setWindowTitle(QApplication::translate("SimpleSubstitution", "Form", Q_NULLPTR));
        use_key->setText(QApplication::translate("SimpleSubstitution", "Use Key", Q_NULLPTR));
        label_5->setText(QApplication::translate("SimpleSubstitution", "Key:", Q_NULLPTR));
    } // retranslateUi
